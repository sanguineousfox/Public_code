/** @file temp_sensors.h @brief Опрос до 8 датчиков LM75B. */
...
#define TEMP_SENSORS_MAX_COUNT        8U
#define TEMP_SENSOR_SCAN_TIMEOUT_MS   20U
#define TEMP_SENSOR_MAX_ERRORS        10U
#define LM75B_BASE_ADDRESS            0x48U

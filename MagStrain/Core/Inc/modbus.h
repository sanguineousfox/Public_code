...
/* Быстрые целочисленные значения для простых дисплеев */
...
/* Точные значения с плавающей точкой для SCADA-систем */
/* Каждый FLOAT32 занимает 2 регистра (адреса идут с шагом 2) */
...
/* Параметры конфигурации, записываются через Modbus */
...
#define MB_ADDR_TANK_SHAPE      2008        /* Способ расчёта объёма жидкости (Gr): 0-вертикальный, 1-горизонтальный с плоскими днищами, 2-по таблице, 3-горизонтальный с эллиптическими днищами */
...
#define MB_ADDR_BAUDRATE_FLT    2064        /* Скорость передачи данных по интерфейсу RS-485 (rS): 0-1200, 1-2400, 2-4800, 3-9600, 4-14400, 5-19200, 6-38400, 7-56000, 8-57600, 9-115200 бит/с */
#define MB_ADDR_PARITY_FLT      2066        /* Режим контроля чётности и количество стоповых бит (rP): 0-8N1, 1-8N2, 2-8O1, 3-8E1 */

...
/* --- ГРУППА 3: НАСТРОЙКИ И КАЛИБРОВКА (FLOAT32) (Адреса 2000-2100) --- */
...
#define MB_ADDR_PULSE_WIDTH_US  2094        /*< ★ Ширина задающего импульса, мкс (динамический параметр) */
#define MB_ADDR_WAVEGUIDE_LEN   2096        /*< Длина звукопровода текущая (Lc), м ★ КЛЮЧЕВОЙ ПАРАМЕТР */
#define MB_ADDR_TOF_FREQ_MHZ    2100        /*< ★ Частота таймера ToF, МГц (динамический параметр) */

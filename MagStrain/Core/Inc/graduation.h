/** @file graduation.h @brief Градуировочные таблицы резервуара. */
#ifndef GRADUATION_H
#define GRADUATION_H
...
#define GRAD_MAX_POINTS          1500U
#define GRAD_EEPROM_BASE         0x0400U
#define GRAD_STORAGE_HEADER_SIZE 32U
#define GRAD_DATA_START          (GRAD_EEPROM_BASE + GRAD_STORAGE_HEADER_SIZE)
#define GRAD_MAGIC               0x47524144UL
#define GRAD_FORMAT_VERSION      2U
